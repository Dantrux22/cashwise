...
const T = {
  es:{
    ...
    tDepositUndone:'↩️ Depósito deshecho', tPaymentReceived:'✅ Pago marcado como recibido',
  ...
  en:{
    ...
    tDepositUndone:'↩️ Deposit undone', tPaymentReceived:'✅ Payment marked as received',
